...
class GenerateContentWithoutLeanResult:
    """Result data for GenerateContentWithoutLean query."""

    content: str


@dataclass
class GenerateContentWithoutLeanQuery(
    Request[Result[GenerateContentWithoutLeanResult, UseCaseError]]
):
...
class GenerateContentWithoutLeanHandler(
    RequestHandler[
        ...
        Result[GenerateContentWithoutLeanResult, UseCaseError],
    ]
):
    ...
    async def handle(
        ...
        async with self._uow:
            ...
            return Ok(GenerateContentWithoutLeanResult(content=content))
